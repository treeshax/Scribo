...
const Ballpit = ({ className = '', followCursor = true, ...props }) => {
  ...
  useEffect(() => {
    ...
    if (!canvas) {
      console.error("Ballpit: Canvas ref is null");
      return;
    }

    console.log("Ballpit: Initializing with parent dimensions:", canvas.parentElement?.offsetWidth, "x", canvas.parentElement?.offsetHeight);
